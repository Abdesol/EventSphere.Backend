    ...
    IConfiguration configuration) : ControllerBase
{
    ...
    {
        // var props = new AuthenticationProperties { RedirectUri = "google-response" };
    ...
    public async Task<IActionResult> GoogleResponse()
    {
        ...
        {
            var generatedUsername = email.Split("@")[0] + " - " + Guid.NewGuid().ToString()[..5];
            await accountService.Register(new UserRegistrationRequestDto(email, generatedUsername,
                ""), true, OAuthClient.Google);
        }
